...
<div class="flex h-screen w-full">
  ...
  <div class="flex w-full flex-col items-center justify-center">
    <form class="flex w-80 flex-col items-center justify-center md:w-96">
      ...
      <div
        class="flex h-12 w-full items-center gap-2 overflow-hidden rounded-full border border-gray-300/60 bg-transparent pl-6"
      >
      ...
      <div
        class="mt-6 flex h-12 w-full items-center gap-2 overflow-hidden rounded-full border border-gray-300/60 bg-transparent pl-6"
      >
