...
export type Mutation = {
   ...
   * 一键清除所有静态页面
   *
   * This asynchronous function attempts to publish a message to the
   * `REMOVE_STATIC_PAGES_JOB` topic with the value `"all"`. If the
   ...
   * message is published successfully, or an error if the operation fails.
   *
   * # Errors
   *
   * Returns an error if the message cannot be published due to a lack of permission
   * or due to a failure of the message broker.
   */
  clearStaticPages: Scalars['String']['output']
   ...
   *
   * * `ctx` - The GraphQL context, used to access application state.
   * * `input` - A `MessageInput` object containing the details of the message to be sent.
   *
   * # Errors
   *
   * Returns an error if the message sending operation fails.
   */
   ...
   *
   * This asynchronous function takes a `ProductInput` object as an argument and
   * stores it in the database. The `created_at` and `updated_at` timestamps are
   * set automatically. The `deleted_at` timestamp is set to `None` initially.
   * The `slug` field is generated automatically based on the `title` field.
   *
   * # Arguments
   *
   * * `ctx` - The GraphQL context containing shared data, including the application state.
   * * `input` - A `ProductInput` object containing the details of the product to be created.
   *
   * # Errors
   *
   * Returns an error if the product cannot be created due to a lack of permission
   ...
   *
   * This asynchronous method deletes a product from the database based
   * on the provided `id`. It first attempts to retrieve the product
   * to ensure it exists before proceeding with the deletion process.
   *
   * # Arguments
   *
   ...
   *
   * Returns a `Result` containing a string with the value `"ok"` if the
   * product was deleted successfully, or an error if the operation fails.
   *
   * # Errors
   *
   * Returns an error if the product is not found or if there is a failure
   * during the deletion process.
   */
   ...
   *
   * This asynchronous function updates a category in the database using the
   * provided `id` and `input`. Existing category details are modified based
   * on the non-null fields in the `input`, while the `slug` field is
   * conditionally updated if a new value is provided.
   *
   * # Arguments
   *
   ...
   * * `input` - A `CategoryInput` object containing the updated category details.
   *
   * # Returns
   *
   * A `Result` which is:
   * * `Ok(String)` - A success message if the category is updated successfully.
   * * `Err(Error)` - An error message if the category update fails.
   *
   * # Errors
   *
   * Returns an error if the category update operation fails due to database issues.
   */
   ...
   *
   * This asynchronous function fetches the current product record by its `id` and updates
   * its fields based on the values provided in the `input`. If a field in the `input` is `None`,
   * the function retains the current value from the existing record.
   *
   * # Arguments
   ...
   * * `input` - A `ProductInput` object containing the updated product details.
   *
   * # Returns
   *
   * Returns a `Result` containing a string with the value `"ok"` if the product is updated
   * successfully, or an error if the operation fails.
   *
   * # Errors
   *
   * Returns an error if the product is not found, or if there is a failure during the update process.
   */
...
export type MutationClearStaticPagesArgs = {
...
export type Query = {
   ...
   *
   * This is a utility function for clients to check if the user is authenticated
   ...
   *
   * This asynchronous function takes a URL as an argument and returns a vector of
   * permission names that the user can use.
   *
   * # Arguments
   *
   * * `ctx` - The context object containing the logged in user information.
   * * `url` - The URL of the resource to check permissions for.
   *
   * # Returns
   *
   * Returns a vector of permission names that the user can use, or an error if the user
   * is not logged in or does not have the given permission.
   */
   ...
   *
   * This asynchronous function queries the database for a product with the given `id`
   * and returns a `ProductObject` if one is found. If no product is found, or if an error
   * occurs during the query, an error is returned.
   *
   * # Arguments
   *
   * * `ctx` - The GraphQL context containing shared data, including the application state.
   ...
   * # Returns
   *
   * Returns a `Result` containing a `ProductObject` if the product is found successfully,
   * or an error if the operation fails.
   *
   * # Errors
   *
   ...
   * `ProductObject` objects. The `PageInput` structure contains the page number and the page size.
   * If the `PageInput` argument is not provided, the method returns the first page of products with
   * a page size of 20.
   *
   * The method returns an error if the user does not have permission to view the list of products.
   *
   * # Arguments
   *
   * *   `ctx` - The execution context of the GraphQL query. This object contains information
   ...
   * *   `category_id` - An optional category ID. If provided, the method will only return products
   * that belong to the specified category.
   *
   * # Errors
   *
   * Returns an error as a `Box<dyn std::error::Error>` if the database query fails or if the
   * user does not have permission to view the list of products.
   */
...
export type RolesQuery = {
  roles: Array<{
    ...
    is_visible: boolean
    sort_id: number
    permission_ids?: Array<number> | null
    menu_ids?: { selected_keys?: Array<number> | null; indeterminate_keys?: Array<number> | null } | null
  }>
...
export type PermissionTypesQuery = {
  permissionTypes: Array<{
    id: number
    name: string
    display_name?: string | null
...
export type AccountsQuery = {
  ...
  platformTypes: Array<{ id: number; name: string }>
}
...
export type SettingQuery = {
  ...
  fileGroups: Array<{ id: number; group_name: string; description?: string | null; parent_id: number; sort_id: number }>
}

export type FileGroupsQueryVariables = Exact<{ [key: string]: never }>

export type FileGroupsQuery = {
  fileGroups: Array<{ id: number; group_name: string; description?: string | null; parent_id: number; sort_id: number }>
}
      ...
      variableDefinitions: [
        {
          ...
          type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'RoleInput' } } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
...
export const UpdateRoleMenusDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'UpdateRoleMenus' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
        ...
        },
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'RoleMenuObject' } } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
...
} as unknown as DocumentNode<UpdateRoleMenusMutation, UpdateRoleMenusMutationVariables>
export const CreatePermissionTypeDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'CreatePermissionType' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'PermissionTypeInput' } },
          },
        },
      ],
      selectionSet: {
...
} as unknown as DocumentNode<CreatePermissionTypeMutation, CreatePermissionTypeMutationVariables>
export const UpdatePermissionTypeDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'UpdatePermissionType' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<UpdatePermissionTypeMutation, UpdatePermissionTypeMutationVariables>
export const DeletePermissionTypeDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'DeletePermissionType' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<DeletePermissionTypeMutation, DeletePermissionTypeMutationVariables>
      ...
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'AccountInput' } } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
      ...
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'PermissionInput' } } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
      ...
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'SettingInput' } } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
...
export const CreateFileGroupDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'CreateFileGroup' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'FileGroupInput' } } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
...
} as unknown as DocumentNode<CreateFileGroupMutation, CreateFileGroupMutationVariables>
export const UpdateFileGroupDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'UpdateFileGroup' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<UpdateFileGroupMutation, UpdateFileGroupMutationVariables>
export const DeleteFileGroupDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'DeleteFileGroup' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<DeleteFileGroupMutation, DeleteFileGroupMutationVariables>
...
} as unknown as DocumentNode<CodeMutation, CodeMutationVariables>
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'CreateMenu' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'MenuInput' } } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
...
} as unknown as DocumentNode<CreateMenuMutation, CreateMenuMutationVariables>
export const UpdateMenuDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'UpdateMenu' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<UpdateMenuMutation, UpdateMenuMutationVariables>
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'DeleteMenu' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<DeleteMenuMutation, DeleteMenuMutationVariables>
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'sort_id' } },
                { kind: 'Field', name: { kind: 'Name', value: 'permission_ids' } },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'menu_ids' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'selected_keys' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'indeterminate_keys' } },
                    ],
                  },
                },
              ],
          ...
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'permissionTypes' },
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'id' } },
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'sort_id' } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: 'Field', name: { kind: 'Name', value: 'affix' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'permissions' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'keep_alive' } },
                    ],
                  },
                },
                {
...
export const PermissionTypesDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
...
} as unknown as DocumentNode<PermissionTypesQuery, PermissionTypesQueryVariables>
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'app_secret' } },
                { kind: 'Field', name: { kind: 'Name', value: 'callback_url' } },
                { kind: 'Field', name: { kind: 'Name', value: 'platform_type' } },
              ],
            },
          },
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'platformTypes' },
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'id' } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'file_group_id' } },
                { kind: 'Field', name: { kind: 'Name', value: 'email_driver' } },
                { kind: 'Field', name: { kind: 'Name', value: 'email_host' } },
                { kind: 'Field', name: { kind: 'Name', value: 'email_port' } },
                { kind: 'Field', name: { kind: 'Name', value: 'email_username' } },
                { kind: 'Field', name: { kind: 'Name', value: 'email_password' } },
                { kind: 'Field', name: { kind: 'Name', value: 'email_encryption' } },
                { kind: 'Field', name: { kind: 'Name', value: 'email_from_address' } },
                { kind: 'Field', name: { kind: 'Name', value: 'email_from_name' } },
                { kind: 'Field', name: { kind: 'Name', value: 'registrable' } },
              ],
            },
          },
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'fileGroups' },
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<FileGroupsQuery, FileGroupsQueryVariables>
